...
export default function Home() { // #09203F
  return (
    <div className={'text-white w-full h-full fixed bg-gradient-to-b to-[#09203F] from-[#181a1f]'}>
      <Navbar>
      ...
      <div className={'text-center mt-[20vh] flex flex-col gap-4'}>
        ...
        <p className={'font-extrabold text-2xl'}>Společně ale můžeme vytvořit silnout alternativu</p>
        <div className={'mt-7 flex justify-center gap-3'}>
          <Button href="/login">Už mám účet!</Button>
          <Button href="/register">Hledám řešení pro naší školu</Button>
        </div>
      </div>
      <div className={'flex text-center mt-[20vh]'}>
          <div className={'flex-[50%]'}>
            <b className={'text-3xl'}>Kdo Jsme? 🚀</b>
          ...
          <div className={'flex-[50%]'}>
            <h1 className={'text-3xl'}><b>Proč my? 🚀</b></h1>
            <ol className={'list-disc list-inside'}>
              <li>
                <b>Větší stabilita</b><br></br>
                <p className={'block'}>
                  MyEdu klade důraz na stabilitu a spolehlivost, což nás odlišuje od konkurence, <br></br>
              ...
              <li>
                ...
                <p className={'block'}>
                  Celý server je hostován u nás, takže se nemusíte o nic starat,<br></br>
              ...
              <li>
                <b>Open Source</b>
                <p className={'block'}>
                  Celý software je dostupný na GitHubu, takže si ho může kdokoliv shlédnout,<br></br>
